...
export class ServicioController {
  ...
  @Post()
  async createServicio(@Body() servicioData: Partial<Servicio>): Promise<Servicio> {
  ...
  @Patch(':id')
  async updateServicio(@Param('id') id: number, @Body() servicioData: Partial<Servicio>): Promise<Servicio> {
