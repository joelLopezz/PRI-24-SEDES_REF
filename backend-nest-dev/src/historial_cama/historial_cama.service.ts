...
export class HistoriaCamaService {
  ...
  //   // Validación: la suma de ocupada, disponible y alta debe ser igual a ofertada
  //   const nuevaOcupada = ofertadaConstante - disponible - alta;
  //   const sumaTotal = disponible + alta + nuevaOcupada;
  //   if (ofertadaConstante !== sumaTotal) {
  //     throw new Error('La suma de disponible y alta debe ser igual a la cantidad ofertada');
  //   }
